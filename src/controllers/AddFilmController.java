...
public class AddFilmController {
	...
	*/
	@FXML
	public void addFilm() {
		Film film = new Film(txtID.getText(), 
				txtTitolo.getText(), 
				txtDescrizione.getText(), 
				txtGenere.getText(), 
				Integer.valueOf(txtDurata.getText()), 
				txtRegista.getText(), 
				txtCast.getText(), 
				Integer.valueOf(txtCosto.getText()),
				selectedCoverPath,
				selectedTrailerPath);
	...
	/**
	* Permette all'utente di scegliere un file di tipo JPG o PNG dal
	* proprio file system
	*/
	@FXML
	...
	/**
	* Permette all'utente di scegliere un file di tipo MP4 dal
	* proprio file system
	*/
	@FXML
